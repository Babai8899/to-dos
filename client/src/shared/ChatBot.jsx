    ...
    return (
        <div>
            <div className="container flex">
                <div className="md:w-1/4 w-full fixed md:top-24 top-20 md:right-5 md:px-2 px-10 z-2">
                    {visible &&
                        <Transitions pageVariants={pageVariants}>
                            <div className='card gap-2 grid border border-gray-300 dark:border-gray-600 p-1 rounded-lg shadow-lg'>
                                <div className="card bg-yellow-50 dark:bg-cyan-700 md:h-80 h-[calc(100vh-10rem-10rem)] rounded-lg shadow-lg text-sm">
                                    <div className='bg-yellow-500 dark:bg-cyan-900 p-2 rounded-t-lg'>Chat Bot</div>
                                    <div className='px-1'>
                                        ...
                                        <div className="chat chat-end">
                                            ...
                                            <div className="chat-bubble bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-gray-200">You underestimate my power!</div>
                                        </div>
                                    </div>
                                </div>
                                <div className='flex justify-between items-center gap-1'>
                                    <input type="text" placeholder="Type here" className="focus:outline-yellow-500 dark:focus:outline-cyan-800 input w-5/6 dark:border-cyan-800 border-yellow-500 bg-yellow-50 dark:bg-gray-800 placeholder:text-gray-800 dark:placeholder:text-gray-200" />
                                    <button className="ease-in-out transition-colors duration-300 p-1 cursor-pointer bg-yellow-500 hover:bg-yellow-400 dark:bg-cyan-800 dark:hover:bg-cyan-600 w-1/6 rounded"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8 mx-auto stroke-gray-800 dark:stroke-gray-200">
