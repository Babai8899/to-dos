...
function ChatBot() {
    ...
    // Function to parse response text and convert URLs to clickable links
                            ...
                            <div className='card gap-2 grid md:border md:w-auto w-screen md:border-gray-300 dark:border-gray-600 p-1 rounded-lg md:shadow-lg'>
                                <div className="card bg-yellow-50 dark:bg-cyan-700 md:h-96 h-[calc(100vh-7rem-7rem)] rounded-md shadow-lg text-sm">
                                    ...
                                    {user === null ?
                                        ...
                                        <div className='px-1 h-full overflow-y-auto' ref={chatContainerRef}>
                                                    ...
                                                    <div key={index}>
                                                        ...
                                                        {chat.response && (
                                                            <div className="chat chat-start">
                                                                ...
                                                                <div className="chat-bubble bg-yellow-500 dark:bg-cyan-900 text-gray-800 dark:text-gray-200 whitespace-pre-wrap">
                                                                    {parseResponseWithLinks(chat.response)}
                                                                </div>
                                                            </div>
                                                        )}
                                                    </div>
                                ...
                                <div className='flex justify-between items-center gap-1'>
                                    <input 
                                        ...
                                        className="focus:outline-yellow-500 dark:focus:outline-cyan-800 input w-5/6 dark:border-cyan-800 border-yellow-500 bg-yellow-50 dark:bg-gray-800 placeholder:text-gray-800 dark:placeholder:text-gray-200" 
                                        name='question' 
                                        value={question} 
                                    ...
                                    />
                                    <button 
                                        className="ease-in-out transition-colors duration-300 p-1 cursor-pointer bg-yellow-500 hover:bg-yellow-400 dark:bg-cyan-800 dark:hover:bg-cyan-600 w-1/6 rounded disabled:opacity-50 disabled:cursor-not-allowed" 
                                        onClick={handleSubmit}
                                        disabled={loading || !question.trim()}
                                    >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8 mx-auto stroke-gray-800 dark:stroke-gray-200">
